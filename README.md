...
<p align="center">
  ...
  LBS 探索 · 云端 VLM 识别 · 动物记录 · 中文 AI 伙伴远征
</p>
...
云端 **VLM** 会用中文识别并描述物种，云端 **LLM** 生成属性与中文幻想档案，再让动物记录中的伙伴进入 AI 远征剧情。
...
| ✦ **伙伴远征** | 选择真实记录中的动物 · 操纵探索幻想地图 · AI 生成全中文奇遇 |
...
<p align="center">
  <img src="docs/assets/loop-animated.svg" alt="核心循环：发现 → 捕获 → 记录 → 探险" width="100%" />
</p>
...
```text
   ...
   ╰──────────╯     ╰──────────╯     ╰──────────╯     ╰──────────╯
        │                 │                 │                 │
     LBS 定位          投掷结算          照片图鉴          方向键探索
     相机取帧          体力 -20          IndexedDB         AI 中文剧情
     VLM Detect        Analyze→Value     云端同步           伙伴羁绊
```
...
| **探险** | 从动物记录选择伙伴；方向键探索幻想地图；AI 生成全中文分支奇遇并结算羁绊 |
| **天气** | 影响捕捉难度与宠物状态（不改刷新） |
...
暖色 **橙色调卡通风** 为主，伙伴远征使用深色日系 RPG 对话框与幻想地图作为剧情层。
