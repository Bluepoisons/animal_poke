...
func SeedNodes() []NodeDef {
	return []NodeDef{
		...
		{NodeID: "ch4_ending_materials", ChapterID: "ch4", Title: "为展览准备材料", Body: "你收集到至少三类材料：空白页注释、角色回响、季节对照。终章展览可选它们。", Kind: "story", Priority: 38},
...
func SeedChoices() []ChoiceDef {
	return []ChoiceDef{
		...
		{ChoiceID: "ch4_city_to_pace_echo", FromNodeID: "ch4_city_change", ToNodeID: "ch4_pace_echo", Label: "回看第一章的选择", Effects: map[string]any{}, SortOrder: 2},
		{ChoiceID: "ch4_pace_to_exhibit", FromNodeID: "ch4_pace_echo", ToNodeID: "ch4_exhibit_three", Label: "带着回响策划展览", Effects: map[string]any{}, SortOrder: 1},
	}
}
